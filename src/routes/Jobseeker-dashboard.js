...
const JobseekerDashboard = () => {
  ...
  const MainContent = () => {
    return (
      <div className="p-6">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Welcome back, {userProfile?.firstName || 'there'}!</h2>
          <p className="text-gray-600">Let's find your next career opportunity</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-gray-50 rounded-lg">
              <div className="h-16 w-16 mx-auto text-gray-400">
                {/* Using a simple SVG instead of Icons.Search */}
